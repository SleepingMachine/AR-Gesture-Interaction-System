...
class Ui_MainWindow(QtWidgets.QWidget):
    ...
    def setupUi(self):
        ...
        self.action_3 = QtWidgets.QAction(self.MainWindow)  # 添加菜单动作
    ...
    def retranslateUi(self):
        ...
        self.MainWindow.setWindowTitle(_translate("MainWindow", "主窗口"))
        ...
        self.action_3.setText(_translate("MainWindow", "识别"))
        self.action_3.triggered.connect(self.start_Identify)
